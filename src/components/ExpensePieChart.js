    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-white px-4 py-3 rounded-lg shadow-xl border border-gray-200">
          ...
          <p className="text-lg font-bold text-gray-900 mb-1">{entry.value.toLocaleString()} ₼</p>
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500">Ümumi: {total.toLocaleString()} ₼</p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <span className="text-xs font-semibold text-gray-500 bg-gray-100 px-2 py-1 rounded">{percentage}%</span>
